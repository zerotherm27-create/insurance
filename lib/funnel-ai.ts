...
const SEGMENT_FRAMING: Record<FunnelSegment, string> = {
  ...
  hnw: `This is a HIGH NET WORTH INDIVIDUAL. Their concern is LEGACY and WEALTH TRANSFER, not monthly income. Frame the report around estate planning, the Philippine 6% estate tax and the need for liquid cash to pay it, clean asset transfer (trusts, clear beneficiaries), avoiding family conflict, and their stated legacy priority. Mention that insurance bypasses probate entirely: assets transfer directly to named beneficiaries without court involvement, without estate tax, and without public disclosure. Position this as the key structural advantage over wills, trusts, and family corporations. NEVER frame this as "income protection" or suggest a small monthly premium. "estimatedRange" should describe the scale of estate-liquidity / legacy coverage worth considering, not a monthly budget. "biggestGap" should focus on estate/transfer risk.`,
}
